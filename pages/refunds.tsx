  ...
  return (
    <LegalPageLayout title="Refund Policy">
      <div>
        ...
        <p>
          At CreatorChat Hub, we strive to provide excellent service to all our users. This refund policy outlines 
        ...
        <ol>
          <li>Contact our support team at support@creatorchathub.com</li>
        ...
        <ul>
          <li>Billing errors by CreatorChat Hub</li>
        ...
        <ul>
          <li>Email: support@creatorchathub.com</li>
